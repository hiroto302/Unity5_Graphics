Shader "patterns/8_grid_square"
{
    Properties
    {
        ...
        _EdgeX("EdgeX", Range(0.0, 1.0)) = 0.5
        _EdgeY("EdgeY", Range(0.0, 1.0)) = 0.5
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half squareOne = strengthX * strengthY;
                half squareTwo = (1.0 - strengthX) * (1.0 - strengthY);

                half combination = squareOne + squareTwo;
